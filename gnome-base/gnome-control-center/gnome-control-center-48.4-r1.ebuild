...
DEPEND="
	>=x11-themes/matrixos-artwork-gnome-0.0.3
...
src_configure() {
	...
	local emesonargs=(
		...
		-Ddistributor_logo=/usr/share/pixmaps/matrixos-logo-lightmode.svg
		-Ddark_mode_distributor_logo=/usr/share/pixmaps/matrixos-logo-darkmode.svg
	)
	meson_src_configure
}
